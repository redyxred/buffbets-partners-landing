...
export function Contacts({ dict, lang, onRegisterClick }: ContactsProps) {
	...
	return (
		<Section
			...
			className="min-h-svh"
		>
			<Container className="flex flex-col min-h-[calc(100svh-var(--header-height-scrolled))]">
				<div className="flex-1 flex items-center">
					<div className="flex flex-col justify-center relative z-10 w-full py-16 sm:py-20 md:py-24">
						<SectionTitle
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
							...
							<div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 sm:space-y-8">
								<div className="flex flex-col font-conthrax uppercase leading-tight">
									<motion.span
										...
										className="text-white text-lg sm:text-xl md:text-3xl"
									>
									...
									<motion.span
										...
										className="text-primary text-xl sm:text-2xl md:text-4xl lg:text-5xl"
									>
								...
								<div className="flex flex-col gap-3 sm:gap-4 w-full max-w-md">
									...
									>
										...
										<span className="text-white text-base sm:text-lg md:text-xl font-bold group-hover:text-primary transition-colors">
								...
								>
									<Button
										...
										size="lg"
										className="bg-[#FFC700] text-black hover:bg-[#FFC700]/90 px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 text-sm sm:text-base md:text-lg shadow-[0_0_30px_rgba(255,199,0,0.4)]"
									>
										{dict.contacts.cta}
									</Button>
								</motion.div>
							...
							<div className="relative w-full flex justify-center lg:justify-end h-40 sm:h-50 md:h-75 lg:h-100">
								<motion.div
									initial={{ scale: 0.8, opacity: 0 }}
									whileInView={{ scale: 1, opacity: 1 }}
									transition={{ duration: 0.8 }}
									className="relative w-full max-w-60 sm:max-w-80 md:max-w-100 lg:max-w-125"
								>
									<motion.div
										animate={{ y: [-10, 10, -10] }}
										transition={{
						...
						<motion.button
							...
							whileTap={{ scale: 0.9 }}
							className="absolute right-0 bottom-0 sm:-bottom-8 md:-bottom-16 w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 cursor-pointer border-2 border-white bg-primary rounded-full flex items-center justify-center text-black z-20"
						>
							<svg
								width="42"
								height="42"
				...
				<Footer dict={dict.footer} lang={lang} className="w-full" />
			</Container>
		</Section>
	);
}
